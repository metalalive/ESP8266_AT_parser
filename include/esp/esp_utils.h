...
// following 2 macros determine whether current set value should be saved to ESP
// device flash as default value, the set value will be applied immediately
// after the ESP is reset next time.
#define ESP_SETVALUE_NOT_SAVE 0
#define ESP_SETVALUE_SAVE     1

// Align `x` value to specific number of bytes, provided by
// ESP_CFG_MEM_ALIGNMENT configuration
